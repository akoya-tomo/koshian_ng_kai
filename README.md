...
* 追加された機能（KOSHIAN NG 改）
  ...
  - ![\(New\)](images/new.png "New") NG対象の板を選択する機能を追加  
    NGワードを適用する板を選択することができます。デフォルトでは全ての板が対象になります。  

## インストール
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_ng_kai/releases/download/v1.7.0/koshian_ng_kai-1.7.0-fx.xpi)
